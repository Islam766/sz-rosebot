...
- Borz может отключать доступ к каналам не подписавшихся пользователей до тех пор, пока они не подпишутся.
...
**Настройка**
1) Прежде всего, добавьте меня в группу как администратора с правом запрета пользователей и в канал как администратора.
Примечание: Только создатель группы может добавить меня, и я не позволю принудительно подписаться снова, если этого не сделать.


**Команды**
- /forcesubscribe - Получить текущие настройки.
- /forcesubscribe no/off/disable - отключить принудительную подписку.
- /forcesubscribe {имя пользователя канала} - Включить и настроить канал.
- /forcesubscribe clear - отключить доступ всем пользователям, которые были отключены мной.

Примечание: /forcesub является псевдонимом /forcesubscribe
"""
